...
Additionally, fruit in the first inventory slot will automatically be planted in any Kegs in the 9 tiles around the player, so you can use the same hotkey in multiple contexts.
